...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *contentV = [[UIView alloc] initWithFrame:CGRectMake(0, screenHeight, screenWith, 300)];
        contentV.backgroundColor = [UIColor whiteColor];
        [self addSubview:contentV];
        self.contentV = contentV;
        
        self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 40, [UIScreen mainScreen].bounds.size.width, 260)];
        ...
        cancelButton.frame = CGRectMake(30, 10, 60, 30);
        [cancelButton setTitle:@"取消" forState:UIControlStateNormal];
        cancelButton.backgroundColor = [UIColor colorWithHexString:app_style_color];
        ...
        chooseButton.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 70, 10, 60, 30 );
        [chooseButton setTitle:@"确定" forState:UIControlStateNormal];
        chooseButton.titleLabel.font = [UIFont systemFontOfSize:14];
        
        chooseButton.backgroundColor = [UIColor colorWithHexString:app_style_color];
...
- (void)hideDateTimePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.alpha = 0;
        _contentV.frame = CGRectMake(0, screenHeight, screenWith, 300);
    } completion:^(BOOL finished) {
...
//    [self hideDateTimePickerView];
    ...
    if ( [self.delegate respondsToSelector:@selector(didClickCancelDateTimePickerView)]) {
        [self.delegate didClickCancelDateTimePickerView];
    }
