...
- (void)configToolView {
    ...
    [saveBtn setTitleColor:[UIColor colorWithHexString:app_style_color] forState:UIControlStateNormal];
    ...
    [cancelBtn setTitleColor:[UIColor colorWithHexString:app_style_color] forState:UIControlStateNormal];
